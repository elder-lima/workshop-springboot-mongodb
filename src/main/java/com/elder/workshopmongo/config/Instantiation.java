package com.elder.workshopmongo.config;
...
import com.elder.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Post post1 = new Post(null, LocalDate.parse("21/03/2018", fmt).atStartOfDay(ZoneId.systemDefault()).toInstant(), "Partiu viagem", "Vou viajar para São Paulo. Abraços!", new AuthorDTO(maria));
        Post post2 = new Post(null, LocalDate.parse("23/03/2018", fmt).atStartOfDay(ZoneId.systemDefault()).toInstant(), "Bom dia", "Acordei feliz hoje!", new AuthorDTO(maria));
